...
$WGET --inet4-only -q https://uptimerobot.com/inc/files/ips/IPv4.txt -O - | while read ip
do
...
$WGET --inet6-only -q https://uptimerobot.com/inc/files/ips/IPv6.txt -O - | while read ip
do
